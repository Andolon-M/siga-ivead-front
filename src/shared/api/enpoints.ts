...
export const API_ENDPOINTS = {
  ...
  MEETINGS: {
    ...
    SESSIONS: {
      ...
      PUBLIC_SETLIST: (sessionId: string) => `/meetings/sessions/public/setlist/${sessionId}`,
      SONGS: {
  ...
  SONGS: {
    ...
    SONG_TYPES: "/songs/types",
    CREATE_SONG_TYPE: "/songs/types",
    UPDATE_SONG_TYPE: (id: string) => `/songs/types/${id}`,
    DELETE_SONG_TYPE: (id: string) => `/songs/types/${id}`,
